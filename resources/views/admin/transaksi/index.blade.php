                    ...
                    <div class="bg-orange-100/50 px-6 py-4 flex justify-between items-center border-b border-orange-200">
                        ...
                        <div class="flex items-center gap-2">
                            <form action="{{ route('admin.transaksi.tagih-wa') }}" method="POST">
                                @csrf
                                <button type="submit" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-xl font-black text-[9px] uppercase tracking-widest transition-all shadow-md shadow-green-100 flex items-center gap-2">
                                    <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.27 9.27 0 01-4.487-1.164l-.325-.19-3.341.876.891-3.256-.208-.332A9.268 9.268 0 013.243 12c0-5.116 4.158-9.274 9.276-9.274 2.48 0 4.81.966 6.561 2.719a9.208 9.208 0 012.715 6.556c0 5.118-4.158 9.275-9.277 9.275M16.602 4.555A11.64 11.64 0 0012.42 2C6.883 2 2.39 6.493 2.39 12.03c0 1.772.463 3.503 1.342 5.03L2 22l5.09-1.335c1.474.804 3.136 1.228 4.828 1.228h.005c5.534 0 10.027-4.493 10.027-10.03 0-2.684-1.046-5.207-2.946-7.107"/></svg>
                                    Tagih Ke Grup
                                </button>
                            </form>
